...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            Log.e(TAG,"featu "+features.length());
            Log.e(TAG,"featu "+features.getJSONObject(0));
            for(int i=0;i<features.length();i++){
                JSONObject currentEarthquake = features.getJSONObject(i);
                JSONObject jsonObject=currentEarthquake.getJSONObject("properties");
                ...
                Log.e(TAG,"mag "+ mag+" place"+place+" time"+time);
